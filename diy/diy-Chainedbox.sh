...
# 修改主机名字，把hostname的值修改你喜欢的就行（不能纯数字或者使用中文）
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Chainedbox'' package/lean/default-settings/files/zzz-default-settings
...
rm -rf feeds/packages/net/luci-app-adguardhome
# rm -rf feeds/packages/net/luci-app-lucky
...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/callacat/OpenWrt'|g" package/luci-app-amlogic/root/etc/config/amlogic
# sed -i "s|kernel_path.*|kernel_path 'https://github.com/ophub/kernel'|g" package/luci-app-amlogic/root/etc/config/amlogic
sed -i "s|ARMv8|Chainedbox|g" package/luci-app-amlogic/root/etc/config/amlogic
